<template>
  <div>
    <input type="checkbox" id="darkmode-toggle" @change="handleToggleChange" />
    <label for="darkmode-toggle" :title="toogleTitle">
      <svg
...
export default defineComponent({
  ...
  methods: {
    handleToggleChange() {
      ...
      this.$emit("toogleChanged", this.isDarkModeActive);
    },
  },
  computed: {
    toogleTitle() {
